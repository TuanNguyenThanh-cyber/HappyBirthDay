...
const config = {
  name: "Minh", // actual name of the recipient (Mandatory)

  nickname: "Chicken", // nickname(optional)
...
CTAtext.innerHTML = "Nhấn vào cái đèn này điii";
...
button.addEventListener("click", function () {
  if (button.classList.contains("switch")) {
    ...
    light.play();
    transition(darkroom);
    CTAtext.innerHTML = "Nhấn vào cái cửa này nèee";
    setTimeout(function () {
    ...
    door.play();
    transition(hallway);
    CTAtext.innerHTML = "Nhấn vào cái món quà này điii";
    setTimeout(function () {
    ...
    document.querySelector(".HBD").textContent = "Chúc mừng sinh nhật em";
